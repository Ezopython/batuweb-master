    ...
    <div class="tm-main-container">
      <div class="tm-top-container">
        ...
        <nav id="tmNav" class="tm-nav">
          <a class="tm-navbar-menu" href="#">Цэс</a>
          <ul class="tm-nav-links">
            <li class="tm-nav-item active">
              <a href="#" data-linkid="0" data-align="right" class="tm-nav-link">танилцуулга</a>
            </li>
            <li class="tm-nav-item">
              <a href="#" data-linkid="1" data-align="right" class="tm-nav-link">бидний тухай</a>
            </li>
            <li class="tm-nav-item">
              <a
                href="#"
                data-linkid="2"
                data-align="middle"
                class="tm-nav-link">бүтээгдхүүн</a>
            </li>
            <li class="tm-nav-item">
              <a href="#" data-linkid="3" data-align="left" class="tm-nav-link">холбоо барих</a>
            </li>
            <li class="tm-nav-item">
              <a
                rel="nofollow" href="https://www.facebook.com/Havtan.PremiumStandard.Mongolia"
                class="tm-nav-link external">сошиал линк</a>
            </li>
          </ul>
        </nav>
          ...
          <div class="col-md-12">
            ...
            <div class="tm-content">
              ...
              <section class="tm-section tm-section-0">
                ...
                <a href="#" id="tm_about_link" data-linkid="1" class="tm-link">цааш үзэх</a>
              </section>

              <!-- Section 1 About Me -->
              <section class="tm-section tm-section-1">
                <div class="tm-textbox tm-textbox-2 tm-bg-dark">
                  <h2 class="tm-text-blue mb-4">бидний тухай</h2>
                  <p class="mb-4">
      ...
      <div class="tm-bottom-container">
        ...
        <!-- <div class="tm-barcode-box">
          <img src="img/bablogo.png" alt="logo" />
        </div> -->
        ...
        <footer>
          || Copyright &copy; 2021 || 
        	...
        	Design: <a rel="nofollow" href="https://www.facebook.com/elecmnshop/">pst.mn</a> || 
